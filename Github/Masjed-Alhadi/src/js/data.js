...
const NIAT_CARDS_RAW = [
		"title": "کمک به مسجد", "menu": [
            { "title": "هزینه‌های جاری مسجد" }, { "title": "مراسمات اهل بیت" }
          ] },
	    {
	    ...
	    { "title": "صدقه اول ماه" },
    {
	    ...
	    { "title": "قربانی", "submenu": [
            { "title": "ذبح گوسفند" }, { "title": "عقیقه" }
        ] },
	    { "title": "کمک به نیازمندان", "menu": [
            { "title": "صدقه" }, { "title": "بسته غذایی" }, { "title": "کمک‌های درمانی" }, { "title": "کمک هزینه تحصیلی" }, { "title": "کمک به ایتام" }, { "title": "کمک هزینه ازدواج" }, { "title": "تأمین و تعمیر لوازم منزل" }, { "title": "کمک به اشتغال" }
          ] },
    {
        "title": "وجوهات شرعی", "menu": [
            { "title": "خمس", "submenu": [{ "title": "خمس عام" }, { "title": "خمس سادات" }] },
